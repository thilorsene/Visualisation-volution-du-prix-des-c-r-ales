...
chart.append("text")
    ...
    chart.append("text").attr("x", 220).attr("y", 400).text("Evolution Prix du Mais Local").style("font-size", "15px").attr("alignment-baseline","middle")
