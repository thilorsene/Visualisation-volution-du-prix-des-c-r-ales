d3.csv('data/Maisloc.csv')
    ...
    .get(function(error,data){
      ...
      .tickSizeOuter (0);
        ...
        var chart = svg.append('g').attr('transform', 'translate(350,' + margin.top + ')');
...
chart.append("text")
    ...
    chart.append("text").attr("x", 220).attr("y", 400).text("Prix Mais Local").style("font-size", "15px").attr("alignment-baseline","middle")
